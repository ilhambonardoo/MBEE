    ...
    try {
      ...
      if (!res.ok) {
        if (data.errors) {
          ...
          toast.error(data.message || "Gagal membuat user baru");
        }
      } else {
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="max-w-xl">
          ...
          <p className="text-base md:text-lg text-neutral-600 dark:text-neutral-400">
            Daftarkan pengguna baru ke sistem untuk memberikan akses manajemen
...
export default CreateSectionUser;
